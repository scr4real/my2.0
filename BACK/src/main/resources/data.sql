...
-- ==================================================================================
-- JAPA UNIVERSE - RESET COMPLETO DE ROUPAS
-- ==================================================================================

-- 3. LOTE ARC'TERYX (Categoria 46)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Arc''teryx Beta AR Jacket Graphite', 'Cor: Graphite. O "All Rounder" da marca. Casaco técnico ultra resistente com GORE-TEX Pro, gola DropHood™ independente e reforços em áreas de alto desgaste.', '/uploads/arcteryx/1.webp', 549.90, 46, 10, 16, 'ARC-BETA-AR'),
('Arc''teryx Beta LT Jacket Black', 'Cor: Black. Proteção GORE-TEX leve (Lightweight) e durável em um design minimalista. Impermeável, corta-vento e respirável.', '/uploads/arcteryx/2.webp', 499.00, 46, 8, 16, 'ARC-BETA-LT'),
('Arc''teryx Beta Jacket Ether', 'Cor: Ether (Azul Bebê). Casaco versátil e silencioso com tecnologia GORE-TEX C-KNIT™. Oferece um toque mais macio na pele e alta respirabilidade.', '/uploads/arcteryx/3.webp', 450.00, 46, 12, 16, 'ARC-BETA-ETH'),
('Arc''teryx Alpha SV Jacket White', 'Cor: White. O modelo topo de linha para condições extremas (Severe). Construído com GORE-TEX Pro 100D para máxima durabilidade.', '/uploads/arcteryx/4.webp', 699.00, 46, 5, 16, 'ARC-ALPHA-SV');

-- 4. LOTE CORTEIZ (Colaboração CBF e Alcatraz)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Corteiz x CBF Brasil Track Jacket White', 'Jaqueta tática exclusiva da colaboração Corteiz e Seleção Brasileira. Design funcional com o escudo da CBF bordado. Estilo drill europeu.', '/uploads/corteiz/1.webp', 389.90, 46, 10, 13, 'CRTZ-CBF-WHT'),
('Corteiz x CBF Brasil Track Jacket Black', 'Versão Black da colaboração com a CBF. Tecido de alta resistência e acabamento premium. Item indispensável para o kit streetwear.', '/uploads/corteiz/2.webp', 389.90, 46, 8, 13, 'CRTZ-CBF-BLK'),
('Corteiz Alcatraz Hoodie Grey', 'O clássico moletom Alcatraz na cor cinza mescla. Estampa frontal do logotipo da ilha em alta definição. Corte oversized autêntico.', '/uploads/corteiz/3.webp', 349.90, 46, 15, 13, 'CRTZ-ALC-GRY'),
('Corteiz Alcatraz Hoodie Black', 'Moletom Corteiz Alcatraz preto. A peça mais icónica do streetwear londrino. Interior flanelado para máximo conforto.', '/uploads/corteiz/4.webp', 349.90, 46, 12, 13, 'CRTZ-ALC-BLK');

-- 5. LOTE DENIM TEARS (Cotton Wreath)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Denim Tears Cotton Wreath Hoodie Grey', 'Moletom cinza mescla com o icónico padrão "Cotton Wreath" (coroa de algodão) em chenille branco espalhado por toda a peça.', '/uploads/denim_tears/1.webp', 449.90, 46, 10, 17, 'DT-CW-GRY'),
('Denim Tears Cotton Wreath Hoodie Black', 'Versão Black do moletom Cotton Wreath. O contraste das flores de algodão brancas sobre o fundo preto garante um visual luxo.', '/uploads/denim_tears/2.webp', 449.90, 46, 12, 17, 'DT-CW-BLK');

-- 6. LOTE PUFFERS (The North Face & Nike)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('The North Face 1996 Retro Nuptse Black', 'Cor: Black. A jaqueta puffer mais icónica do mundo. Enchimento em penugem de ganso 700 fill para isolamento térmico extremo.', '/uploads/puffer/1.webp', 899.90, 46, 10, 18, 'TNF-96-BLK'),
('The North Face 1996 Retro Nuptse Navy', 'Cor: Navy Blue. Design em dois tons com peitoral reforçado. Estética retrô com gomos largos e alta durabilidade.', '/uploads/puffer/2.webp', 899.90, 46, 8, 18, 'TNF-96-NVY'),
('Nike Sportswear Windrunner Puffer Grey', 'Cor: Grey. Jaqueta puffer com design chevron clássico. Isolamento sintético leve que retém o calor eficientemente.', '/uploads/puffer/3.webp', 549.90, 46, 12, 1, 'NIKE-PF-GRY'),
('Nike Sportswear Windrunner Puffer Sand', 'Cor: Sand (Bege). Visual moderno em tons terrosos. Proteção térmica com tecnologia Storm-FIT para manter o corpo seco.', '/uploads/puffer/4.webp', 549.90, 46, 7, 1, 'NIKE-PF-SND'),
('Nike Sportswear Windrunner Puffer Olive', 'Cor: Olive Green. Pegada tática urbana com acabamento elástico nos punhos para vedação total contra o frio.', '/uploads/puffer/5.webp', 549.90, 46, 10, 1, 'NIKE-PF-OLV'),
('Nike Sportswear Windrunner Puffer Black', 'Cor: Black. Versão "All Black" minimalista com o Swoosh no peito. Conforto térmico superior para o inverno.', '/uploads/puffer/6.webp', 549.90, 46, 15, 1, 'NIKE-PF-BLK');

-- 7. LOTE RALPH LAUREN (Crewnecks e Zip-ups)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Polo Ralph Lauren Crewneck Black', 'Moletom gola careca clássico preto. Logotipo Pony bordado no peito. Elegância e conforto premium em algodão.', '/uploads/ralph_lauren/1.webp', 329.90, 46, 10, 19, 'RL-CW-BLK'),
('Polo Ralph Lauren Crewneck Grey', 'Moletom gola careca cinza mescla. Peça versátil de alta qualidade com acabamento canelado nos punhos e barra.', '/uploads/ralph_lauren/2.webp', 329.90, 46, 12, 19, 'RL-CW-GRY'),
('Polo Ralph Lauren Crewneck White', 'Versão branca do moletom Polo Ralph Lauren. Estilo casual refinado ideal para sobreposições táticas.', '/uploads/ralph_lauren/3.webp', 329.90, 46, 8, 19, 'RL-CW-WHT'),
('Polo Ralph Lauren Zip Hoodie Black/Red', 'Moletom com fecho e capuz preto. Logotipo Pony bordado em vermelho. Praticidade com bolsos canguru.', '/uploads/ralph_lauren/4.webp', 399.90, 46, 10, 19, 'RL-ZIP-BLKRED'),
('Polo Ralph Lauren Zip Hoodie White', 'Hoodie com fecho branco e logotipo azul marinho. Interior levemente flanelado para conforto térmico prolongado.', '/uploads/ralph_lauren/5.webp', 399.90, 46, 7, 19, 'RL-ZIP-WHTBLU'),
('Polo Ralph Lauren Zip Hoodie Black/White', 'Moletom com fecho preto e logotipo branco. O básico essencial para um visual sofisticado no streetwear.', '/uploads/ralph_lauren/6.webp', 399.90, 46, 15, 19, 'RL-ZIP-BLKWHT'),
('Polo Ralph Lauren Zip Hoodie Navy', 'Moletom com fecho azul marinho e logotipo vermelho. Uma das combinações de cores mais tradicionais da marca.', '/uploads/ralph_lauren/7.webp', 399.90, 46, 9, 19, 'RL-ZIP-NVYRED');

-- 8. LOTE SYNA WORLD (Hoodies Logo)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Syna World Logo Hoodie Black', 'Moletom preto com logotipo grafite. Cordões brancos espessos e corte oversized característico da Syna World.', '/uploads/syna/1.webp', 399.90, 46, 10, 15, 'SYNA-HOD-BLK'),
('Syna World Logo Hoodie Sage', 'Cor: Sage Green. Moletom com toque macio e logotipo bordado tom sobre tom. Estética drill de luxo.', '/uploads/syna/2.webp', 399.90, 46, 8, 15, 'SYNA-HOD-SGE'),
('Syna World Logo Hoodie Blue', 'Cor: Blue. Azul vibrante com o icónico logotipo Syna em branco. Acabamento premium e caimento largo.', '/uploads/syna/3.webp', 399.90, 46, 12, 15, 'SYNA-HOD-BLU'),
('Syna World Logo Hoodie Red', 'Cor: Red. Vermelho intenso com logotipo branco. Peça de destaque com cordões contrastantes exclusivos.', '/uploads/syna/4.webp', 399.90, 46, 7, 15, 'SYNA-HOD-RED');

-- 9. LOTE TECH FLEECE (Organizado: 1-6 Padrão, 7-10 Nocta, 11 Syna)
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Nike Tech Fleece G2 Brown', 'Cor: Baroque Brown. Nova geração (G2) com design ergonómico e bolso tático colado no braço.', '/uploads/tech_fleece/1.webp', 499.90, 46, 10, 1, 'NIKE-TF-BRW'),
('Nike Tech Fleece G2 Burgundy', 'Cor: Burgundy. Estilo moderno com fecho duplo. O isolamento térmico premium original da Nike.', '/uploads/tech_fleece/2.webp', 499.90, 46, 8, 1, 'NIKE-TF-BUR'),
...
('Nike Tech Fleece G2 Black', 'Cor: Black. O modelo clássico mais vendido na versão atualizada G2. Detalhes em fita colada.', '/uploads/tech_fleece/4.webp', 499.90, 46, 20, 1, 'NIKE-TF-BLK'),
('Nike Tech Fleece G2 Heather Grey', 'Cor: Dark Grey Heather. Cinza mescla escuro com detalhes pretos. Conforto térmico imbatível.', '/uploads/tech_fleece/5.webp', 499.90, 46, 15, 1, 'NIKE-TF-DGRY'),
('Nike Tech Fleece G2 Panda', 'Cor: Grey/Black. Design "Panda" com blocos de cores contrastantes na nova modelagem G2.', '/uploads/tech_fleece/6.webp', 499.90, 46, 10, 1, 'NIKE-TF-PAN'),
('Nike x Nocta Tech Fleece White', 'Colaboração Nocta (Drake). Cor: White. Design minimalista com Swoosh refletivo e cortes técnicos.', '/uploads/tech_fleece/7.webp', 599.90, 46, 5, 1, 'NOCTA-TF-WHT'),
('Nike x Nocta Tech Fleece Baby Blue', 'Colaboração Nocta. Cor: Baby Blue. Peça premium com tecido de dupla face da coleção Drake.', '/uploads/tech_fleece/8.webp', 599.90, 46, 6, 1, 'NOCTA-TF-BBLU'),
('Nike x Nocta Tech Fleece Black', 'Colaboração Nocta. Cor: Black. Apresenta o clássico logotipo Nocta em amarelo e detalhes refletivos.', '/uploads/tech_fleece/9.webp', 599.90, 46, 10, 1, 'NOCTA-TF-BLK'),
('Nike x Nocta Tech Fleece Green', 'Colaboração Nocta. Cor: Green (Verde). Design tático com a cor vibrante exclusiva da linha Nocta.', '/uploads/tech_fleece/10.webp', 599.90, 46, 5, 1, 'NOCTA-TF-GRN'),
...
-- 10. LOTE TRAPSTAR
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Trapstar Shooters Hoodie Grey', 'Moletom Trapstar London cinza. Logotipo "Shooters" frontal com gradiente azul/preto. O kit essencial drill.', '/uploads/trapstar/1.webp', 349.90, 46, 10, 14, 'TRP-SHO-GRY'),
('Trapstar Shooters Hoodie Black', 'Versão Black do moletom Shooters. Acabamento premium com capuz ajustável e estilo underground.', '/uploads/trapstar/2.webp', 349.90, 46, 12, 14, 'TRP-SHO-BLK');

-- ==================================================================================
-- LOTE FINAL ROUPAS: TRACKSUITS (CONJUNTOS) - ITENS 1 A 24
-- ==================================================================================

-- Categoria 47 = Conjuntos
INSERT INTO produtos (nome, descricao, imagem_url, preco, categoria_id, estoque, marca_id, codigo_modelo) VALUES 
('Conjunto Treino PSG Jordan White', 'Conjunto oficial Paris Saint-Germain x Jordan. Blusa branca com calça azul marinho. Tecnologia Dri-FIT para máximo conforto.', '/uploads/tracksuit/1.webp', 449.90, 47, 10, 1, 'TRK-PSG-WHT'),
...
('Conjunto Treino França Blue Pattern', 'Conjunto oficial de treino da Seleção Francesa com estampa gráfica exclusiva em tons de azul. Tecnologia Dri-FIT de alta performance.', '/uploads/tracksuit/25.webp', 449.90, 47, 8, 1, 'TRK-FRA-PAT'),
('Conjunto Treino Chelsea Black/White', 'Kit de treino oficial do Chelsea FC. Blusa preta com ombros brancos e calça de treino ajustada. Escudo do clube bordado em destaque.', '/uploads/tracksuit/26.webp', 449.90, 47, 10, 1, 'TRK-CHE-BLK'),
('Conjunto Treino Liverpool Red/AXA', 'Conjunto Liverpool na cor vermelha vibrante com patrocínio AXA. Design focado em mobilidade e conforto térmico para atletas.', '/uploads/tracksuit/27.webp', 449.90, 47, 7, 1, 'TRK-LFC-RED'),
('Conjunto Treino Brasil Mint Green', 'Edição especial Brasil na cor verde menta. Visual moderno e leve, ideal para sessões de treino sob o sol ou uso casual tático.', '/uploads/tracksuit/28.webp', 449.90, 47, 6, 1, 'TRK-BRA-MNT'),
('Conjunto Treino Arsenal Navy/Blue', 'Conjunto Arsenal FC em azul marinho com detalhes em azul claro. Tecido técnico respirável com o escudo dos Gunners no peito.', '/uploads/tracksuit/29.webp', 449.90, 47, 9, 3, 'TRK-ARS-NVY'),
('Conjunto Treino Ajax Teal/Blue', 'Conjunto de treino oficial do Ajax. Combinação de azul turquesa e azul royal com as icônicas listras da marca nas laterais.', '/uploads/tracksuit/30.webp', 449.90, 47, 5, 3, 'TRK-AJX-TEA'),
('Conjunto Treino Itália White/Blue', 'Kit de treino Seleção Italiana. Blusa branca com detalhes em azul e verde, representando a bandeira nacional. Alta gramatura técnica.', '/uploads/tracksuit/31.webp', 449.90, 47, 8, 3, 'TRK-ITA-WHT'),
('Conjunto Treino França Navy/Cyan', 'Versão de treino da França em azul marinho com detalhes em ciano nas mangas. Design ergonômico para máximo rendimento.', '/uploads/tracksuit/32.webp', 449.90, 47, 10, 1, 'TRK-FRA-CYA'),
('Conjunto Treino PSG White/Black Pattern', 'Conjunto Paris Saint-Germain com blusa branca e detalhes gráficos pretos nas mangas. Calça preta com logotipos em contraste.', '/uploads/tracksuit/33.webp', 449.90, 47, 12, 1, 'TRK-PSG-PAT'),
('Conjunto Treino PSG White/Red', 'Conjunto de treino PSG oficial. Blusa branca com detalhes em vermelho e patrocínio ALL. O kit clássico de treinamento parisiense.', '/uploads/tracksuit/34.webp', 449.90, 47, 15, 1, 'TRK-PSG-RED'),
('Conjunto Treino Brasil Yellow/Blue', 'O icônico conjunto de treino do Brasil nas cores da bandeira. Blusa amarela vibrante e calça azul marinho. Orgulho nacional.', '/uploads/tracksuit/35.webp', 449.90, 47, 20, 1, 'TRK-BRA-YEL'),
('Conjunto Treino Arsenal Navy/Red Detail', 'Versão tática do Arsenal em azul marinho com detalhes em vermelho nos ombros. Fechamento em zíper 1/4 e caimento profissional.', '/uploads/tracksuit/36.webp', 449.90, 47, 10, 3, 'TRK-ARS-DET');